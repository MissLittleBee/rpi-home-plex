...
async function initiateDownload(fileId, fileName) {
    ...
    const contentTypeName = contentType === 'series' ? 'Seriály' : 'Filmy';
    ...
    if (progressContainer) {
        ...
        updateProgress(progressFill, progressText, 0, `Preparing download to ${contentTypeName}...`);
    }

    try {
        showToast(`🔄 Starting download to ${contentTypeName}...`, 'info');
